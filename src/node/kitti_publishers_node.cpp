...
void KittiPublishersNode::on_timer_callback() {
	...
	// 02- KITTI IMAGE MESSAGES START- gray_left(image_00), gray_right(image_01), color_left(image_02),
	// color_right(image_03)//
...
void KittiPublishersNode::convert_pcl_to_pointcloud2(sensor_msgs::msg::PointCloud2& msg) {
	...
	std::string filePath =
	    get_path(KittiPublishersNode::PublisherType::POINT_CLOUD) + file_names_point_cloud_[file_index_];
...
void KittiPublishersNode::init_file_path() {
	path_point_cloud_ = "data/2011_09_26/2011_09_26_drive_0117_sync/velodyne_points/data/";
	path_image_gray_left_ = "data/2011_09_26/2011_09_26_drive_0117_sync/image_00/data/";
	path_image_gray_right_ = "data/2011_09_26/2011_09_26_drive_0117_sync/image_01/data/";
	path_image_color_left_ = "data/2011_09_26/2011_09_26_drive_0117_sync/image_02/data/";
	path_image_color_right_ = "data/2011_09_26/2011_09_26_drive_0117_sync/image_03/data/";
	path_oxts_ = "data/2011_09_26/2011_09_26_drive_0117_sync/oxts/data/";
}
...
void KittiPublishersNode::create_publishers_data_file_names() {
	for (int type_index = 0; type_index != 6; type_index++) {
		...
		try {
			for (auto const& entry : std::filesystem::directory_iterator(get_path(type))) {
			...
			std::sort(file_names.begin(), file_names.end(), [](auto const& lhs, auto const& rhs) { return lhs < rhs; });
...
void KittiPublishersNode::prepare_navsatfix_msg(std::vector<std::string>& oxts_tokenized_array,
...
void KittiPublishersNode::prepare_marker_array_msg(std::vector<std::string>& oxts_tokenized_array,
                                                   visualization_msgs::msg::MarkerArray& msg) {
	double const lat = std::stod(oxts_tokenized_array[0]);
	double const lon = std::stod(oxts_tokenized_array[1]);

	double ref_lat = 49.011647132256;
	double ref_lon = 8.411831900761;

	std::array<double, 2> WGS84Reference{ref_lat, ref_lon};
...
std::vector<std::string> KittiPublishersNode::parse_file_data_into_string_array(std::string file_name,
